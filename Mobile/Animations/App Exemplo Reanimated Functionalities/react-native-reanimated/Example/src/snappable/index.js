...
class Snappable extends Component {
  constructor(props) {
    ...
    this._transX = cond(
      ...
      [
        stopClock(clock),  /// essa linha eh ra quando tipo eu soltei jah a caixa e ela ta fazendo o spring, 
        //mas ai eu posso resolver clicar nele e arrastar no meio da animacao do spring e ai tem que parar de fazer a animacao e me deixar arrastar
